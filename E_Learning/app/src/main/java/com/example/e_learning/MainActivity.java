...
public class MainActivity extends TabActivity implements OnClickListener {
	...
	private void prepareIntent() {
		mHomeItent = new Intent(this, ConversationActivity.class);
		mChannelIntent = new Intent(this, StarActivity.class);
		mAccountIntent = new Intent(this, GroupActivity.class);
		mMoreIntent = new Intent(this, SettingActivity.class);
	}
